...
import { Dialog, DialogActions, DialogContent, useMediaQuery, Button } from "@mui/material";
...
export function confirmWrapper(message, title, okLabel = "Ok", onConfirm = null, options = {}) {

...
import {cm} from "./tokens";

// Tema MUI da linha Colibri UI: faz os componentes MUI terem o visual dos componentes `cm-`
// de colibri-ui.css (ver DESIGN.md, seção 7). Não crie variações locais: derive de `cm`.
...
const floatingShadow = "0 6px 16px rgba(18, 38, 63, .12)";

const theme = createTheme({
    palette: {
        primary: {main: cm.accent, dark: cm.accentHover, light: cm.accentSoft, contrastText: "#fff"},
        secondary: {main: cm.ink2, dark: cm.ink, light: cm.mutedSoft, contrastText: "#fff"},
        error: {main: cm.danger, light: cm.dangerSoft, contrastText: "#fff"},
        warning: {main: cm.warning, light: cm.warningSoft, contrastText: "#fff"},
        success: {main: cm.success, light: cm.successSoft, contrastText: "#fff"},
        info: {main: cm.accent, light: cm.accentSoft, contrastText: "#fff"},
            ...
            styleOverrides: {
                ...
                contained: ({ownerState}) => {
                    ...
                    return {
                        color: "#fff",
                        background: bg,
                        border: `1px solid ${danger ? "#8f1e2c" : cm.accentBorder}`,
                        "&:hover": {background: danger ? "#951f2e" : cm.accentHover},
                        "&.Mui-disabled": {color: "#fff", background: bg},
                    };
                },
        ...
        MuiDialog: {
            styleOverrides: {
                paper: {
                    ...
                    border: `1px solid ${cm.line}`,
                    borderRadius: cm.radius,
                    boxShadow: "0 12px 32px rgba(18, 38, 63, .18)",
                },
                paperFullScreen: {margin: 0, border: 0, borderRadius: 0},
            },
        },
        MuiBackdrop: {
            styleOverrides: {root: {"&:not(.MuiBackdrop-invisible)": {background: "rgba(12, 30, 50, .4)"}}},
        },
        MuiDialogTitle: {
            styleOverrides: {
                root: {
